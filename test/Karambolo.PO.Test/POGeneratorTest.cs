...
namespace Karambolo.PO.Test
{
    ...
    public class POGeneratorTest
    {
        ...
        [Theory]
        [InlineData(@"01234567891123456789212345678931234567894123456789512345678961234567897123456789812345678991234567890123456789112345678921234567893123456789412345678951234567896123456789712345678981234567899123456789",
            new string[]
            {
        ...
        [InlineData(@"012345678911234567892123456789312345678941234567895123456789612345678971234567""98123456789",
            new string[]
            {
                @"""012345678911234567892123456789312345678941234567895123456789612345678971234567""",
                @"""\""98123456789"""
            })]
        [InlineData(@"01234567891123456789212345678931234567894123456789512345678961234567897123456\	98123456789",
            new string[]
            {
                @"""01234567891123456789212345678931234567894123456789512345678961234567897123456""",
                @"""\\\t98123456789"""
            })]
        [InlineData(@"0123456789112345678921234567893123456789412345678951234567896123456789712345\\""98123456789",
            new string[]
            {
                @"""0123456789112345678921234567893123456789412345678951234567896123456789712345\\""",
                @"""\\\""98123456789"""
            })]
        [InlineData(@"01234567891123456789212345678931234567894123456789512345678961234567897123456""898123456789",
            new string[]
            {
                @"""01234567891123456789212345678931234567894123456789512345678961234567897123456""",
                @"""\""898123456789"""
            })]
        [InlineData(@"0123456789112345678921234567893123456789412345678951234567896123456789712345\	898123456789",
            new string[]
            {
                @"""0123456789112345678921234567893123456789412345678951234567896123456789712345\\""",
                @"""\t898123456789"""
            })]
        [InlineData(@"012345678911234567892123456789312345678941234567895123456789612345678971234\\""898123456789",
            new string[]
            {
        ...
        [InlineData("012345678911234567892123456789312345678941234567895123456789612345678971234567\r\n8123456789",
            new string[]
            {
                @"""012345678911234567892123456789312345678941234567895123456789612345678971234567""",
                @"""\n""",
        ...
        [InlineData("01234567891123456789212345678931234567894123456789512345678961234567897123456\r\n98123456789",
            new string[]
            {
                @"""01234567891123456789212345678931234567894123456789512345678961234567897123456""",
                @"""\n""",
        ...
        [InlineData("012345678911234567892123456789312345678941234567895123456789612345678971234567\r98123456789",
            new string[]
            {
                @"""012345678911234567892123456789312345678941234567895123456789612345678971234567""",
                @"""\n""",
        ...
        [InlineData("01234567891123456789212345678931234567894123456789512345678961234567897123456\r898123456789",
            new string[]
            {
                @"""01234567891123456789212345678931234567894123456789512345678961234567897123456""",
                @"""\n""",
        ...
        [InlineData("01234567891123456789",
            new string[]
            {
                @"""01234567""",
                @"""89112345""",
        ...
        public void Generate_LineBreak(string id, string[] expectedLines, int? maxLineLength = null)
        {
            ...
            {
                settings.MaxLineLength = maxLineLength.Value;
            }
            ...
            expected.Add(@"msgid """"");
            expected.AddRange(expectedLines);
            expected.Add(@"msgstr """"");

            var generated = sb.ToString();
            var index = generated.IndexOf("msgid \"", 1, StringComparison.Ordinal);
            IEnumerable<string> actual = generated.Substring(index).Split(new[] { Environment.NewLine }, StringSplitOptions.None).Take(expectedLines.Length + 2);
